...
<div id="footer">
	<div class="float_nav">
		<ul>
			<li><a href="/reservation/"><img src="/common/img/sp_ic_mail.png" alt="" width="60px" height="auto" loading="lazy">WEB予約フォーム</a></li>
			<li><a href="tel:0120331244"><img src="/common/img/sp_ic_tel.png" alt="" width="60px" height="auto" loading="lazy">電話相談・ご予約<br><span class="number">0120-331-244</span><br><span class="time">受付時間：9:00～18:00</span></a></li>
			<!--
	...
	<footer>
		...
		<div class="inner">
			...
			<nav id="footNav" class="clrfix">
				<p id="footTel"><img src="https://www.ike-sunshine.co.jp/wp-content/uploads/footer_2108.png" loading="lazy" width="201" height="36" alt="0120-331-244　受付時間：9:00～18:00（完全予約制）"/></p>
				<div class="map">
					<p>
