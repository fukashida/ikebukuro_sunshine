...
if ($_SERVER['SCRIPT_NAME'] == $dir . "/finish.php") {
	...
	if (isset($_POST['send'])) {
		...
		$headers = "From: info@ike-sunshine.co.jp\r\n"
				. "Reply-To: info@ike-sunshine.co.jp\r\n";

		mb_send_mail($to, $subject, $body, $headers);


		// === 社内用メール ===
		$to = "info@ike-sunshine.co.jp";
		...
		mb_send_mail($to, $subject, $body, $headers, "info@ike-sunshine.co.jp");
		...
		// 二重送信防止のためリダイレクト
		header("Location: {$dir}/finish.php?success=1");
		exit;
	}
}
...
<div id="mainContents">
	<main class="finish">
		...
		<section class="secBox">
			...
			<p class="mb20"> お問い合わせありがとうございました。<br>
				ご予約を承りました。 </p>
			<a href="/" class="icon">トップページへもどる</a> </section>
	</main>
</div>
<!--/#mainContents--> 
<!--/ここまでコンテンツ-->
