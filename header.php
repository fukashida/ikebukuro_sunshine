...
<PageMap>
	<DataObject type="thumbnail">
		...
		<Attribute name="src" value="/img/top/im_profile01.jpg"/>
		<?php else: ?>
...
<link rel="stylesheet" rel="preload" type="text/css" href="/common/css/common_index.css?<?php echo filemtime( './common/css/common_index.css'); ?>"  as="style" />
<?php else: ?>
<link rel="stylesheet" type="text/css" href="/common/css/common.css?<?php echo filemtime( './common/css/common.css'); ?>" />
<?php endif; ?>
...
<link rel="stylesheet" type="text/css" href="/css/blogs.css?<?php echo filemtime( './css/blogs.css'); ?>">
<?php } elseif (is_home()) {  ?>
<link rel="stylesheet" rel="preload" type="text/css" href="/css/index.css?<?php echo filemtime( './css/index.css'); ?>" as="style">
...
echo $root_slug
?>.css?<?php echo filemtime( './css/' . $root_slug . '.css'); ?>">

<?php } elseif (is_category() || is_single() || is_search()){ ?>
<link rel="stylesheet" type="text/css" href="/css/news.css?<?php echo filemtime( './css/news.css'); ?>">
<?php } elseif (preg_match('/reservation/', $_SERVER['REQUEST_URI'], $matches) != 0  || preg_match('/inquiry/', $_SERVER['REQUEST_URI'], $matches) != 0){  ?>
<link rel="stylesheet" type="text/css" href="/css/form.css?<?php echo filemtime( './css/form.css'); ?>">
<?php } ?>

<script type="text/javascript" src="/common/js/jquery.min.js"></script>
<!-- ハンバーガーメニュー -->
<script defer type="text/javascript" src="/common/js/modernizr.js"></script>
<script defer type="text/javascript" src="/common/js/common.js?<?php echo filemtime( './common/js/common.js'); ?>"></script>
<!-- 画像遅延読み込み -->
<script defer type="text/javascript" src="/common/js/lazysizes.min.js"></script>
<!-- background-image webp対応-->
<script defer src="/common/js/modernizr-custom.js"></script>
...
"founder":"鈴木栄樹",
    ...
    "contactPoint" :[
        { "@type" : "ContactPoint",
         "url" : "https://www.ike-sunshine.co.jp/reservation/",
...
<div id="header">
	...
	<div id="headWrap">
		...
		<p id="headTel"><picture><source srcset="/common/img/im_head_tel_dark.webp" type='image/webp'><img src="/common/img/im_head_tel_dark.png" loading="lazy" width="201" height="36" alt="0120-331-244　受付時間：9:00～18:00（完全予約制）" data-eio="p"></picture></p>
		<ul id="headContact">
		...
		<ul class="spNav">
			<li><a href="/operations/"><img src="/common/img/sp_ic04.png" alt="治療メニュー">治療メニュー</a></li>
			<li><a href="/charge/"><img src="/common/img/sp_ic03.png" alt="料金一覧">料金一覧</a></li>
			<li><a href="/blogs/"><img src="/common/img/sp_ic_blog.png" alt="ブログ">ブログ</a></li>
			<li><a href="/flow/"><img src="/common/img/sp_ic_flow.png" alt="ご利用の流れ">ご利用の流れ</a></li>
			<li><a href="/greetings/"><img src="/common/img/sp_ic01.png" alt="院長紹介">院長紹介</a></li>
			<li><a href="/map/"><img src="/common/img/sp_ic02.png" alt="アクセス・医院概要">アクセス・医院概要</a></li>
			<li class="bg"><a href="tel:0120331244"><img src="/common/img/sp_ic_tel.png" alt="電話によるご予約">電話によるご予約</a></li>
			<li class="bg"><a href="/reservation/"><img src="/common/img/sp_ic_mail.png" alt="WEB予約フォーム">WEB予約フォーム</a></li>
			<li>
				<!--sns icon-->
				<ul class="sns-link">
					<li><a href="https://page.line.me/xdy5304p" target="_blank"><img src="/img/top/sns_icon_line.png" alt="LINE＠" loading="lazy"></a></li>
					<li><a href="https://twitter.com/ikesunshine?ref_src=twsrc%5Etfw" target="_blank"><img src="/img/top/sns_icon_twitter.png" alt="ツイッター" loading="lazy"></a></li>
					<li><a href="https://www.instagram.com/ikesunshine331244/" target="_blank"><img src="/img/top/sns_icon_insta.png" alt="インスタグラム" loading="lazy"></a></li>
					<li><a href="https://www.facebook.com/ikesunshine2016/" target="_blank"><img src="/img/top/sns_icon_fb.png" alt="フェイスブック" loading="lazy"></a></li>
				</ul>
				<!--/sns icon-->
			</li>
		</ul>
